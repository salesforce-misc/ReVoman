...
data class PostmanEnvironment<ValueT : Any?>(
  ...
  @JvmField val immutableEnvironment = mutableEnv.toMap()

  fun set(key: String, value: ValueT) {
    mutableEnv[key] = value
    logger.info {
      "pm environment variable set through Test JS script : key : ${pprint(key)}, value: ${pprint(value)}"
    }
  }
  ...
  fun unset(key: String) {
    ...
    logger.info { "pm environment variable unset through JS script : key : ${pprint(key)}" }
  }
