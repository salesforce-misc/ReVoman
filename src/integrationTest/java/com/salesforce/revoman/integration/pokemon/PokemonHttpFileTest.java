...
class PokemonHttpFileTest {

  private static final String HTTP_FILE_PATH = "http-templates/pokemon/pokemon.http";
  private static final String HTTP_CLIENT_ENV_PATH = "http-templates/pokemon/http-client.env.json";
  private static final int LIMIT = 3;
  private static final int OFFSET = 0;
  private static final Logger LOGGER = LoggerFactory.getLogger(PokemonHttpFileTest.class);
  ...
  @Test
  void pokemonViaHttpFile() {
    final var newLimit = 1;
    final var dynamicEnvironment = Map.of("offset", OFFSET);
    ...
    final var pokeRundown =
        ReVoman.revUp(config.overrideDynamicEnvironment(Map.of("offset", OFFSET, "limit", LIMIT)));
