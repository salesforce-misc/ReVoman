...
public final class ReVomanConfigForWfs {
  ...
  // * NOTE 2026-07-07 gopal.akshintala: multi zero-primary (request carries >1 assignedResource,
  // * none primary; WorkforceSchdMulResSchdPref enabled) -> up-front INVALID_INPUT NoPrimary
