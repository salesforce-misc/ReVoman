...
....
  ReṼoman ▸ executing API-Graph ······································
   01   POST    /objects           201    142 ms   ✓   → {id}
   02   GET     /objects           200     88 ms   ✓
   03   GET     /objects/{id}      200     76 ms   ✓   ← {id}
   04   PATCH   /objects/{id}      200    110 ms   ✓   ← {id}
  ················································· 4 steps · 4 passed
   › rundown.toJson(VERBOSE)
   { "stepReports": [ 4 — all passed ], "mutableEnv": {…}, "stats": {…} }
....

The four steps above are a real, passing run against the free public https://restful-api.dev[restful-api.dev] — `POST` creates an object, later steps reuse its `{id}`. Here is the test that produces it:
...
<4> Assert the run had no failures
<5> Assert on the structured https://salesforce-misc.github.io/ReVoman/revoman/rundown.html[Rundown]
...
| https://salesforce-misc.github.io/ReVoman/revoman/migration-guide.html[Major-version migration guide]
