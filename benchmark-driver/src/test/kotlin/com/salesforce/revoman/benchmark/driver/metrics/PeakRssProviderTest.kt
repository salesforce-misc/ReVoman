...
class PeakRssProviderTest {
    ...
    fun `GNU time converts maximum RSS KiB to bytes and isolates provider output`() {
        ...
        val prefix = GnuTimePeakRssProvider.invocationPrefix(providerOutput)
        ...
        assertThat(prefix)
            ...
            .inOrder()
        assertThat(prefix).doesNotContain("2>")
    ...
    fun `macOS time keeps maximum RSS bytes and isolates provider output`() {
        ...
        val prefix = MacOsTimePeakRssProvider.invocationPrefix(providerOutput)
