...
TIP: To compose an ordered, named chain of collections that reads like the story it executes — with per-step data-flow contracts and a grouped run log — use a xref:runbook.adoc[Runbook].
